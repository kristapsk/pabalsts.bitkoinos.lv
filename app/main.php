...
?>
        <tr>
            ...
            <td><?php
                if ($diff > 0) {
                    $afterTaxesEUR = $initialSumEUR + ($diff * 0.745);
                }
                else {
